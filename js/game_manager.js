...
GameManager.prototype.reStart = function () {
  this.init();
  this.start();
  this.HTMLredraw.updateScore({ value: this.score }); // Обновите отображение счета
  this.HTMLredraw.updateLossCount({ loss: this.loss }); // Обновите отображение жизней
  this.over = false;
  this.won = false;
  this.HTMLredraw.messageWrap.hide(); // Скройте сообщение об окончании игры
  this.runGear(); // Запустите игровой цикл снова
};
